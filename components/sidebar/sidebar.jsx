...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-0 bg-gray-100 border-r border-gray-700 dark:bg-gray-800 dark:border-gray-700">
